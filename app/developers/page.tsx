    ...
    <div className="min-h-[calc(100vh-64px)] py-12 px-4 bg-X-white dark:bg-X-dark flex items-center justify-center">
      ...
      >
        <div className="text-center space-y-4">
          <div className="w-16 h-16 bg-X-purple/20 rounded-2xl flex items-center justify-center mx-auto text-X-purple">
            <Code size={32} />
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="glass-panel p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            {errors.skills && <span className="text-xs text-X-pink">Required</span>}
          </div>
